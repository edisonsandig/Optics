              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php
	$result=mysqli_query($connection, "SELECT * FROM incident");
	
                    echo '
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
						  <th style="font-family:Nexa Bold; font-size: 12.5px; letter-spacing:.5px">Incident Number</th>
                          <th style="font-family:Nexa Bold; font-size: 12.5px; letter-spacing:.5px">Student Number</th>
                          <th style="font-family:Nexa Bold; font-size: 12.5px; letter-spacing:.5px">Room Name</th>
                          <th style="font-family:Nexa Bold; font-size: 12.5px; letter-spacing:.5px">Date Happened</th>
                          <th style="font-family:Nexa Bold; font-size: 12.5px; letter-spacing:.5px">Incident</th>
